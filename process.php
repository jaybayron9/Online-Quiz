...
if($_POST)
	{
		...
		//What will be the previous question number
		$back = $number-1;
		...
		if($number == $total_questions)
			{
		 ...
		 else
		 	{
		 		if(isset($_POST['back'])) 
			 		{
					 	$_SESSION['score']--;
					 	header("LOCATION: http://localhost/quiz/question.php?n=". $back);						
			 		}
			 	else 
			 		{
		 				header("LOCATION: http://localhost/quiz/question.php?n=". $next);
		 			}
		 	}
	}
